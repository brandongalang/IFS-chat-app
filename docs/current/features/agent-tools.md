...
## How it works
- **Schema Integrity (2025-12-14)**: `logRelationshipSchema` now enforces that relationships cannot be created between a part and itself (validation is case-insensitive), ensuring data model integrity for part relationships.
